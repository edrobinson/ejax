...
The file  "Ejax/src/Ejax.js" contains the client side portion of the project using the DOM.  

The file Ejax/src/Ejax-jq.js uses Jquery which must be scripted in ahead of it.
...
#### Ejax.js Source Code:  
As with the serversideclass, I have included documentation comments in the 
JS code
```
/**
